...
namespace SistGestNotas.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreAsignatura")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreAsignatura")] Asignatura asignatura)
        {
            if (id != asignatura.Id)
            {
                return NotFound();
